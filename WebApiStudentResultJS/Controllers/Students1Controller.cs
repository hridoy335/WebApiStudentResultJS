...
namespace WebApiStudentResultJS.Controllers
{
    public class Students1Controller : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "StudentId,StudentName,StudentMobile,StudentAddress")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "StudentId,StudentName,StudentMobile,StudentAddress")] Student student)
        {
            if (ModelState.IsValid)
            {
